import type { SolutionExecutionFrameworkSectionProps } from "@/features/solutions/types";
...
export default function SolutionExecutionFrameworkSection({
  form,
  disabled,
}: SolutionExecutionFrameworkSectionProps) {
  ...
  return (
    <CollapsibleBox title={t("solutions.execution_framework_section")}>
