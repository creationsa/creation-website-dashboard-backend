  ...
  z
    .array(
      z.object({
        ...
        value_en: englishField(
          t,
          MIN_DESCRIPTION_LENGTH,
          MAX_DESCRIPTION_LENGTH,
        ),
        value_ar: normalField(
          t,
          MIN_DESCRIPTION_LENGTH,
          MAX_DESCRIPTION_LENGTH,
        ),
...
export const createSolutionSchema = (t: TFunction) => {
  ...
  const baseSolutionSchema = z.object({
    ...
    proposition_desc_en: englishField(t, MIN_DESCRIPTION_LENGTH, 1000),
    proposition_desc_ar: normalField(t, MIN_DESCRIPTION_LENGTH, 1000),

    small_description_en: englishField(t, MIN_DESCRIPTION_LENGTH, 300),
    small_description_ar: normalField(t, MIN_DESCRIPTION_LENGTH, 300),

    // Shown on this solution's card on the listing page.
    card_icon: z.object({
      file: svgImageField(t),
