...
export async function generateMetadata({
  ...
  const title = `${common.creation} | ${common.faq}`;

  const description = faq.seo_description;

  const currentUrl = `https://www.creation.sa/${locale}/faq`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ar: `https://www.creation.sa/ar/faq`,
        en: `https://www.creation.sa/en/faq`,
      },
    },
...
export default async function FAQ() {
  ...
  return (
    <>
      <PageBanner
        pageTitle={Faq.header_title}
        home={common.home}
        titleCut={common.faq}
      />

      <Questions faq={Faq} locale={locale} />
    </>
  );
}
