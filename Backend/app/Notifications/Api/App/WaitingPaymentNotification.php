...
class WaitingPaymentNotification extends Notification implements ShouldBroadcast
{
    use Queueable;
    ...
    public function __construct($offer)
    {
        ...
        $this->title = [
            'ar' => trans('Your Offer has been accepted, waiting for payment by the client', [], 'ar'),
            'en' => trans('Your Offer has been accepted, waiting for payment by the client', [], 'en'),
        ];
        $this->body = [
            'ar' => trans('Your Offer has been accepted, waiting for payment by the client ', [], 'ar'),
            'en' => trans('Your Offer has been accepted, waiting for payment by the client ', [], 'en'),
