...
class ArrivedTripNotification extends Notification implements ShouldBroadcast
{
    use Queueable;
    ...
    public function __construct($trip, $type = null)
    {
        ...
        $this->title = [
            'ar' => trans('The Driver has been arrived at the location', [], 'ar'),
            'en' => trans('The Driver has been arrived at the location', [], 'en'),
        ];

        $this->body = [
            'ar' => trans('The Driver has been arrived at the location', ['name' => $this->user->full_name], 'ar'),
            'en' => trans('The Driver has been arrived at the location', ['name' => $this->user->full_name], 'en'),
        ];
