...
class GoToLocationTripNotification extends Notification implements ShouldBroadcast
{
    use Queueable;
    ...
    public function __construct($trip, $type = null)
    {
        ...
        $this->type = $type;
        $this->title = [
            'ar' => trans('The Driver is going at the location', [], 'ar'),
            'en' => trans('The Driver is going at the location', [], 'en'),
        ];

        $this->body = [
            'ar' => trans('Your Driver is going at the location', ['name' => $this->user->full_name], 'ar'),
            'en' => trans('Your Driver is going at the location', ['name' => $this->user->full_name], 'en'),
        ];
