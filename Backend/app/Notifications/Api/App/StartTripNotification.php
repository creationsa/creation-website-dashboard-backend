...
class StartTripNotification extends Notification implements ShouldBroadcast
{
    use Queueable;
    ...
    public function __construct($trip, $type = null)
    {
        ...
        $this->type = $type;
        $this->title = [
            'ar' => trans('Your Trip has been started', [], 'ar'),
            'en' => trans('Your Trip has been started', [], 'en'),
        ];

        $this->body = [
            'ar' => trans('Your Trip has been started', ['name' => $this->user->full_name], 'ar'),
            'en' => trans('Your Trip has been started', ['name' => $this->user->full_name], 'en'),
        ];
