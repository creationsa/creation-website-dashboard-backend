...
class SMSService
{
  public static function send(array $sender, array $data, array $date_time, $service_provider = 'hisms')
  {
    switch ($service_provider) {
      ...
      case 'net_powers':
        ...
        break;
      case 'fcc_sms':
        $validate_msg = self::sendFccSMS($sender, $data, $date_time);
        break;
  ...
  public static function sendFccSMS($message,$phone)
  {
    // $url = "https://api.future-club.com/falconapi_sa/fccsms.aspx?IID=2613&UID=UsrDarf&P=5abfaa18-c6da-4847-b9c2-776e86253e13&S=WFIT&G=20".$phone."&M=".$message."&L=A";

    $url = "https://api.future-club.com/falconapi_sa/fccsms.aspx";
    $params = [
      'IID' => '2613',
      'UID' => 'UsrDarf',
      'P' => '5abfaa18-c6da-4847-b9c2-776e86253e13',
      'S' => 'darf',
      'G' => '966'.$phone,
      'M' => $message,
      'L' => 'A'
