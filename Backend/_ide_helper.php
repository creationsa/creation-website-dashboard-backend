...
namespace  {
             ...
             * @param string $column
             * @static 
             */            public static function filterByDate($startDate = null, $endDate = null, $column = 'created_at')
            {
                                return \Illuminate\Database\Eloquent\Builder::filterByDate($startDate, $endDate, $column);
            }
                            /**
