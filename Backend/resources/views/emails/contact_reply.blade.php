                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <p
                                                    ...
                                                    <span
                                                        style="font-size:25px;color:#fff">Dear,<strong>{!! $data['name'] ?? '' !!}</strong></span>
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div style="line-height:1.5;font-size:12px;font-family:Poppins;color:#fff">
                                            <p
                                                ...
                                                <span style="color:#fff;font-size:15px">{!! $data['reply'] ?? '' !!}</span>
                                            </p>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td style="padding: 15px 0 30px; ">
                                        <div style="line-height:1.5;font-size:12px;font-family:Poppins;color:#fff">
                                            <a href="{{ $data['route'] ?? '' }}" target="_blank"
                                                ...
                                                <p>Best regards,</p>
                                                <p>The Al Almiya Al Hura Team</p>
                                            </a>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td style="word-break:break-word;vertical-align:top;padding-bottom:0;padding-right:5px;padding-left:5px;place-content: center;margin: auto; display:flex;column-gap: 10px;"
                            ...
                            <a href="https://www.twitter.com/" target="_blank"
                                ...
                                <img width="16" height=""
                                    ...
                                    title="Twitter" style="text-decoration:none;height:auto;border:none;display:block;"
                                    class="CToWUd">
                            </a>
                        </td>
                    </tr>
